...
wp_enqueue_script( 'olympus-main', get_template_directory_uri() . '/js/theme-main.js', array(  'smooth-scroll', 'material-forms', 'scroll-to-fixed', 'olympus-mega-menu' ), $theme_version, true );
