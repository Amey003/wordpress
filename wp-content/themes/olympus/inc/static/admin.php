...
//wp_enqueue_script( 'wp-color-picker-alpha', get_template_directory_uri() . '/js/plugins/wp-color-picker-alpha.min.js', array( 'jquery', 'wp-color-picker','wpColorPickerL10n' ), $theme_version, true );
