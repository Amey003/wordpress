...
<div class="wrap">
	...
	<div class="content">
		...
		<div class="update-flex main-block">
			...
			<img loading="lazy" class="update-image" src="<?php echo get_theme_file_uri('images/admin/guy-update.png'); ?>" alt="OlympusV2">
		...
		<div class="update-flex">
			<img loading="lazy" class="update-image" src="<?php echo get_theme_file_uri('images/admin/step1.jpg'); ?>" alt="Step 1">
		...
		<div class="update-flex">
			<img loading="lazy" class="update-image" src="<?php echo get_theme_file_uri('images/admin/step2.jpg'); ?>" alt="Step 2">
		...
		<div class="update-flex">
			<img loading="lazy" class="update-image" src="<?php echo get_theme_file_uri('images/admin/step3.jpg'); ?>" alt="Step 3">
		...
		<div class="update-flex">
			<img loading="lazy" class="update-image" src="<?php echo get_theme_file_uri('images/admin/step4.jpg'); ?>" alt="Step 4">
		...
		<div class="update-flex">
			<img loading="lazy" class="update-image" src="<?php echo get_theme_file_uri('images/admin/step5.jpg'); ?>" alt="Step 4">
