			...
			<?php if ( is_active_sidebar( 'sidebar-footer' ) ) { ?>
				<div class="<?php echo esc_attr( $sidebar_columns ); ?>">
					<div class="row">
						...
						$output					 = ob_get_clean();
						$footer_sibebar_columns	 = $olympus->get_option( 'footer-widget-block-columns', 4, $olympus::SOURCE_CUSTOMIZER );
						$footer_sibebar_columns	 = 'col-lg-' . $footer_sibebar_columns . ' col-md-6 col-sm-6 col-xs-12';
