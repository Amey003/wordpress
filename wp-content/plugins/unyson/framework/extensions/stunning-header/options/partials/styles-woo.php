...
if (class_exists('Olympus_Options')) {
    ...
    $stunning_breadcrumbs_show = $olympus->get_option( "woocommerce_header-stunning-content/yes/stunning_breadcrumbs_show", "yes", $olympus::SOURCE_SETTINGS );
    $stunning_title_show = $olympus->get_option( "woocommerce_header-stunning-content/yes/stunning_title_show/show", "yes", $olympus::SOURCE_SETTINGS );
    $stunning_title_show_title = $olympus->get_option( "woocommerce_header-stunning-content/yes/stunning_title_show/yes/title", "", $olympus::SOURCE_SETTINGS );
    $stunning_text = $olympus->get_option( "woocommerce_header-stunning-content/yes/stunning_text", "", $olympus::SOURCE_SETTINGS );
}
